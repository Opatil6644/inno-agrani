...
def main():
    ...
    model = AutoModel.from_pretrained('GSAI-ML/LLaDA-8B-Instruct', trust_remote_code=True, torch_dtype=torch.bfloat16, revision="08b83a6feb34df1a6011b80c3c00c7563e963b07").to(device).eval()
    tokenizer = AutoTokenizer.from_pretrained('GSAI-ML/LLaDA-8B-Instruct', trust_remote_code=True, revision="08b83a6feb34df1a6011b80c3c00c7563e963b07")
