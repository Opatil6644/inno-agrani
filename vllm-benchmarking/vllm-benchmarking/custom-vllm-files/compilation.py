...
class CompilationConfig:
    ...
    mode: str = envs.VLLM_COMPILATION_MODE
    """Compilation mode for optimization strategy.
    Options:
    - "default": standard compilation behavior
    - "autotune": enable autotuning for optimal performance
    - "aggressive": aggressive optimization passes

    Can be set via VLLM_COMPILATION_MODE environment variable.
    """
